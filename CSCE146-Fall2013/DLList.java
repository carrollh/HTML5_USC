...
public class DLList {
	private DLLNode head = null;	// pointer to the head Node, once it exists
	...
	/**
	 * Helper method that returns the DLLNode at the specified position in this list.
	 * @param index
	 * @return
	 * @throws IndexOutOfBoundsException
	 */
	private DLLNode getNode(int index) throws IndexOutOfBoundsException {
		if(index >= size) throw new IndexOutOfBoundsException();
		else if(head != null) {
			DLLNode temp = head;
			int counter = 0;
	 ...
	 * Note: this method returns null if the DLList has not had any
	 * data added to it.
	...
	/**
	 * Returns a String consisting of "DLList: [ item0, item1, ... ]"
	 */
	@Override
	public String toString() {
		String output = "DLList: [ ";
	...
	/**
	 * Node class for the DLList class above. It stores whatever 
	 * data is needed stored, and has a DLLNode pointer to the 
